...
const TypeMutations: Record<string, TypeMutation> = {
    ...
    GArray: {
        ...
        intro: [
            ...
            `proxy(): { [Symbol.iterator](): IteratorObject<T>, [n: number]: T } & Pick<Array, "length" | "push" | "pop" | "indexOf" | "includes">`,
            "",
    ...
    GDictionary: {
        ...
        intro: [
            ...
            "/** Returns a Proxy that targets this GArray but behaves similar to a regular JavaScript object. Values are exposed as enumerable properties, so Object.keys(), Object.entries() etc. will work. */",
