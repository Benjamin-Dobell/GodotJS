...
import type { ClassBinder, ExportOptions } from "godot.annotations"; // Looks odd, but comes from godot.generated.d.ts i.e. codegen.
...
type ClassMemberDecorator<RestrictedContext extends ClassMemberDecoratorContext = ClassMemberDecoratorContext> =
...
type ClassMemberDecoratorTarget<Context extends ClassMemberDecoratorContext> =
            ...
            : Context extends ClassSetterDecoratorContext<infer _, infer Value>
                ...
                : Context extends ClassFieldDecoratorContext
                    ...
                    : Context extends ClassAccessorDecoratorContext<infer _, infer Value>
                        ...
                        : never;
type ClassMemberDecoratorReturn<Context extends ClassMemberDecoratorContext> =
...
type ClassDecorator<This extends abstract new (...args: any) => any = abstract new (...args: any) => any> =
    (target: This, context: ClassDecoratorContext<This>) => void;
type ClassDecoratorClass<Context extends ClassDecoratorContext> = Context extends ClassDecoratorContext<infer Class>
    ? Class
    : never;

type Decorator<RestrictedContext extends DecoratorContext = DecoratorContext> =
...
type AnyDecorator = (value: unknown, context: DecoratorContext) => unknown;

type ClassValueMemberDecoratorContext<This = unknown, Value = unknown> =
