...
namespace jsb
{
    ...
    void ScriptClassInfo::instantiate(Environment* p_env, const StringName& p_module_id, const v8::Local<v8::Object>& p_self, const std::vector<v8::Local<v8::Value>>& p_parameters)
    {
        ...
        if (script.is_valid())
        {
            ...
            const ScriptInstance* script_instance = script->instance_create(p_self, p_env->flags_ & Environment::EnvironmentFlags::EF_Shadow, p_parameters);
